# One Game a Month - July 2015 Edition!

[![Travis build status](https://travis-ci.org/bploeckelman/GAM-2015-July.svg)](https://travis-ci.org/bploeckelman/GAM-2015-July)
...
If you need to install `git` and clone the project, do that first:
    ...
    brew install git
    mkdir ~/code && cd ~/code
    git clone git@github.com:bploeckelman/GAM-2015-July.git
    cd GAM-2015-July
