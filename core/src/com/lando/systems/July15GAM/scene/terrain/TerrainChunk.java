...
/** This is a test class, showing how one could implement a height field.
 * Do not expect this to be a fully supported and implemented height field class.
 * <p />
 * Represents a TerrainChunk, which is an evenly spaced grid of values, where each value defines the height on that position of the
